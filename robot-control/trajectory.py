...
'''
if stage == 1:
    print('My drill site: x={} y={}'.format(my_drill_site[0], my_drill_site[1]))
    print('True drill site: x={} y={}'.format(mission_1[0], -mission_1[1]))
if stage == 2:
    print('Mission 1 ended on: x={} y={}]'.format(mission_1[0], -mission_1[1]))
    print('Mission 2 ended on: x={} y={}]'.format(mission_2[0], -mission_2[1]))
    print('Mission 3 ended on: x={} y={}]'.format(mission_3[0], -mission_3[1]))
'''
if stage == 1:
